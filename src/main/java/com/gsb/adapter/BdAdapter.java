...
import com.gsb.database.CreateBdEchantillon;
import com.gsb.modele.Echantillon;

public class BdAdapter<unEchant> {
    ...
    public BdAdapter(Context context) {
        ...
        bdArticles = new CreateBdEchantillon((Context) context, NOM_BDD, null, VERSION_BDD);
    }
    ...
    private Echantillon cursorToEchant(Cursor c) {
        ...
        if (c.getCount() != 0) {
            ...
            unEchant = new Echantillon("A0001","ACAI Baie extrait","100");
